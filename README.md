...
A professional and comprehensive **security and system administration toolkit** for Linux environments, including:

* Enterprise Active Directory pentest labs
* Cloud and container targets
* LLM/AI security training
* Automation scripts for hands-on learning and offensive/defensive practice

> Use only in environments you own or are explicitly authorized to test. Unauthorized use is strictly prohibited.
...
Follow the instructions in each **lab** or **script** directory.
...
* Networking troubleshooting documentation
...
**Purpose:** Introduces AI and LLM attack surfaces in enterprise environments.
